...
class TriviaWorlds:
    def __init__(self, master):
        ...
        master.configure(bg="#f0f8ff")  # Light background
        
        self.current_level = 1
        self.correct_answers = 0
        
        self.level_status = [None for _ in range(TOTAL_LEVELS)]  # None, 'passed', 'failed'
    ...
    def show_start_screen(self):
        ...
        start_button = tk.Button(self.master, text="Start Game", font=("Comic Sans MS", 18), bg="#4CAF50", fg="white", width=15, height=2, command=self.show_level_map)
    ...
    def show_level_map(self):
        ...
        for i in range(1, TOTAL_LEVELS + 1):
            btn = tk.Button(self.levels_frame, text=f"Level {i}", width=12, height=2, font=("Comic Sans MS", 14, "bold"),
    ...
    def show_question(self):
        ...
        label = tk.Label(self.master, text=self.current_question["question"], font=("Arial", 20, "bold"), wraplength=700, bg="#f0f8ff")
        label.pack(pady=30)
        ...
        for opt in options:
            ...
            btn = tk.Radiobutton(self.master, text=text, variable=self.selected_answer, value=opt, font=("Arial", 16), bg="#f0f8ff")
            btn.pack(anchor="w", padx=150)
        
        submit_btn = tk.Button(self.master, text="Submit Answer", font=("Comic Sans MS", 16, "bold"), bg="#2196F3", fg="white", command=self.check_answer)
    ...
    def finish_level(self):
        ...
        back_btn = tk.Button(self.master, text="Back to Level Map", font=("Comic Sans MS", 16), bg="#4CAF50", fg="white", command=self.show_level_map)
    ...
    def show_victory_animation(self):
        self.clear_screen()
        label = tk.Label(self.master, text="Congratulations! You completed TriviaWorlds! 🎉", font=("Comic Sans MS", 28, "bold"), bg="#f0f8ff", fg="gold")
        label.pack(pady=50)

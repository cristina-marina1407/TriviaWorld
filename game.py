...
# load all questions at the start of the game
all_questions = load_questions()

# get a random set of questions for the current level
...
class TriviaWorlds:
    ...
    # handle the window resize and adjust the background image
    ...
    # display the level selection map
    def show_level_map(self):
        ...
        # create a frame for level buttons
    ...
    def finish_level(self):
        ...
        if passed:
            ...
            # add a button to return to the level map
            map_btn = tk.Button(self.master,
                                text="Back to Level Map",
                                font=("Comic Sans MS", 24),
                                bg="#4CAF50", fg="white",
    ...
    def _create_confetti(self):
        ...
        # put the confetti on random positions on the axis
        for _ in range(100):
    ...
    # update the colors of the level buttons based on their status
